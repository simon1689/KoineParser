...
export const disjunctiveParticiple: WordPart = {name: 'Disjunctive participle', abbreviation: 'PRT', type: suffixType};
...
export const allWordTypes: WordPart[] = [verb, noun, adverb, adjective, article, conjunction,
  ...
  correlativeOrInterrogativePronoun, indefinitePronoun, conditionalType];
...
export const middlePassiveVoice: WordPart = {name: 'Middle or passive', abbreviation: 'E', type: voiceType};
